...
Verified Hudl athlete profiles live in `site-data/hudl.json` (52 payload rows / 49 unique recruits; 359 unmatched skipped). Re-apply with `python3 scripts/apply-hudl.py` then `npm run import:site`. Do not invent Hudl URLs.
